...
module.exports = new function () {
    ...
    var metadata = {
        ...
        amzn_appId: "amzn1.ask.skill.ba60b448-bfa8-4054-b48e-c6939bde7555",
        channelSecretKey: "Ah1FGj3l9C67pF0ZpMwA75yMM90X1XC3",
        channelUrl: "https://botv2frk1I0005H735E97bots-mpaasocimt.botmxp.ocp.oraclecloud.com:443/connectors/v1/tenants/idcs-6d466372210e4300bb31f4db15e8e96c/listeners/webhook/channels/26da3156-1a92-4197-b20b-a22a8873db6e"
    };
    ...
    this.init = function (config) {
        ...
        alexa_app.launch(function (alexa_req, alexa_res) {
            ...
            alexa_res.say("Welcome to bot.");
	    var card = {'type':'Simple', 'title':'Welcome to bot', 'content':'This is an example card'};
	    alexa_res.card(card);
        });
